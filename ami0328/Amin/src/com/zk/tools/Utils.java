...
//								DataType.TWO_BYTE_INT_UNSIGNED));
		...
		// 送丝
		batchRead.addLocator(Config.Total_length, BaseLocator.holdingRegister(slaveID, 8192, DataType.FOUR_BYTE_FLOAT_SWAPPED));
		batchRead.addLocator(Config.speed, BaseLocator.holdingRegister(slaveID, 8194, DataType.FOUR_BYTE_FLOAT_SWAPPED));
		
		//气体
		
		// 气体流量器1
		batchRead.addLocator(Config.Current_Rate_1, BaseLocator.holdingRegister(
						slaveID, 8196, DataType.FOUR_BYTE_INT_UNSIGNED_SWAPPED));
		batchRead.addLocator(Config.Total_Rate_1, BaseLocator.holdingRegister(
				slaveID, 8198, DataType.FOUR_BYTE_INT_UNSIGNED_SWAPPED));
